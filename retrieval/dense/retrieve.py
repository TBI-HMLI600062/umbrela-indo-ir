...
Examples:
    ...
    # Qwen-embed from Karolina's pre-built chunks:
    python retrieval/dense/retrieve.py \
        --faiss-chunks embeddings/qwen-chunks/ \
        --model Qwen/Qwen2.5-7B-Instruct \
        --topics data/miracl-id/topics/test.tsv \
        --output candidates/qwen_test_top100.jsonl
"""
...
_DECODER_TYPES = {"qwen2", "llama", "mistral", "gemma", "phi", "falcon"}
